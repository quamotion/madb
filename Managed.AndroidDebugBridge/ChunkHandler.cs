...
namespace Managed.Adb {
     ...
     */
    abstract void clientReady(Client client);
    ...
    protected void handleUnknownChunk(Client client, int type,
        MemoryStream data, boolean isReply, int msgId) {
        if (type == CHUNK_FAIL) {
     ...
     */
    static EndianBinaryReader allocBuffer(int maxChunkLen) {
     ...
     * chunk data.
     */
    static EndianBinaryReader GetChunkDataBuf(MemoryStream jdwpBuf) {
