...
namespace Managed.Adb.Tests
{
    ...
    public class ListingServiceTests : BaseDeviceTests
    {
        ...
        public void ResolveStorageDirectoryTest()
        {
            ...
            FileEntry storage = device.FileListingService.FindFileEntry("/storage/");
            Assert.AreEqual("/storage/", storage.FullResolvedPath);

            FileEntry apk = device.FileListingService.FindFileEntry("/storage/emulated/legacy/a584a9d6-1e29-4a4b-b8fb-23aa3f378b56.apk");
